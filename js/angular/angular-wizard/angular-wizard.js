...
angular.module("step.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("step.html",
    "<section ng-show=\"selected\" ng-class=\"{current: selected, done: completed}\" class=\"step animated fadeInRight\" ng-transclude>\n" +
    "</section>");
}]);
...
angular.module("wizard.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("wizard.html",
    ...
    "        <a ng-click=\"goTo(step)\"><span class=\"steps-icon\"><i class=\"fa fa-{{step.iconname}}\" aria-hidden=\"true\"></i></span><span class=\"step-name\">{{step.title || step.wzTitle}}</span></a>\n"+
    "      </li>\n" +
    "    </ul>\n" +
    "</div>\n" +
    "");
